...
def generate_cert(cert_dir: Path, ip: str) -> tuple[Path, Path]:
    ...
    # FIX: datetime.utcnow() emits a DeprecationWarning on Python 3.12+
    # (and is scheduled for removal). Use timezone-aware UTC datetimes,
    # which is what x509 expects anyway.
